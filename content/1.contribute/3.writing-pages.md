...
All content for The Digital Catechism is written in Markdown, Vue components, and MDC syntax.
...
The Digital Catechism supports multiple Front-matter attributes for pages.

```md [index.md]
---
title: "Get Started"
description: "Let's learn how to write an awesome page."
---
```
